return {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      local fuzzySearchCurrentBuf = function()
      ...
      Kmap(Search_Help, builtin.help_tags)
      Kmap(Search_Keymaps, builtin.keymaps)
      Kmap(Search_Files, builtin.find_files)
      Kmap(Search_Pickers, builtin.builtin)
      Kmap(Search_Text, builtin.live_grep)
      Kmap(Search_Errors, builtin.diagnostics)
      Kmap(Search_Resume, builtin.resume)
      Kmap(Search_CurrentWord, builtin.grep_string)
      Kmap(Search_Buffers, builtin.buffers)
      Kmap(Search_CurrentBuffer, fuzzySearchCurrentBuf)
    end,
  },
  -- LSP Plugins
  {
